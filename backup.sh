...
tar cvfz db/monitoreo_juegos_$d.tar.gz db/monitoreo_juegos_$d.db db/monitoreo_juegos_todo.db
rclone copy db/monitoreo_juegos_$d.tar.gz gdrive:monitoreo_juegos_backup
rm -f db/monitoreo_juegos_$d.db
rm -f db/monitoreo_juegos_$d.tar.gz
