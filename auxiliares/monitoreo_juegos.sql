...
CREATE TABLE juegos (
                            ...
                            BGG_id INTEGER NOT NULL,
                            nombre TEXT NOT NULL,
                            nombre_noacentos TEXT NOT NULL,
                            nombre_espanol TEXT NOT NULL,
                            BGG_prioridad TEXT,
                            BGG_ranking INTEGER,
                            BGG_dependencia_leng INT
                            );
...
CREATE TABLE avisos (
                            ...
                            id_usuario INTEGER NOT NULL,
                            aviso_oferta TEXT NOT NULL,
                            aviso_reposicion TEXT NOT NULL,
                            aviso_venta TEXT NOT NULL,
                            );
