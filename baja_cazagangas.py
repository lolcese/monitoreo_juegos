...
cursor.execute('SELECT DISTINCT BGG_id, nombre, dependencia_leng, ranking FROM juegos WHERE precio_actual, nom_alt_1, nom_alt_2, nom_alt_3, nom_alt_4, nom_alt_5, nom_alt_6, nom_alt_7, nom_alt_8 NOT NULL ORDER BY nombre')
